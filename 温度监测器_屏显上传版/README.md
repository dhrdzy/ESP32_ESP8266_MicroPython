# 温度监测器_屏显上传版，100元，可用范围：ESP32
- 利用DS18B20模块+屏显检测温度，检测温度范围-55℃到+125℃，并可以上传到某个网络接口进行远程监控。
...
- 9、main.py中可以动态配置Name、GPIO端口、传输地址、间隔时间（秒）。
- [设备激活地址](http://invasion.x3322.net:82/BindMachine/)

<img decoding="async" src="https://github.com/dhrdzy/ESP32_ESP8266_MicroPython/blob/main/温度监测器_屏显上传版/1.png" width="14%" hight="14%"> 
