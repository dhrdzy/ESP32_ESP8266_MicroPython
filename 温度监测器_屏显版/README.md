# 温度监测器_屏显版，5元，可用范围：ESP32
- 利用DS18B20模块+屏显检测温度，检测温度范围-55℃到+125℃，可用来制作温度计手动测试温度使用。
...
- 9、main.py中可以动态配置GPIO端口、间隔时间（秒）。
- [设备激活地址](http://invasion.x3322.net:82/BindMachine/)

<img decoding="async" src="https://github.com/dhrdzy/ESP32_ESP8266_MicroPython/blob/main/温度监测器_屏显版/1.png" width="14%" hight="14%"> 
